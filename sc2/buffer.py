...
class ReplayBuffer:
    ...
    def store_transition(self, state, information, action, reward, state_, information_, done):
    ...
    def sample_buffer(self):
        ...
        return states, information, actions, rewards, states_, information_, terminals,batch
